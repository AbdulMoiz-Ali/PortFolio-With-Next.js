...
import Uplodeinfo from "./uplodeinfo";
import Image from "next/image";
import contactlogo from "@/app/public/InShot_20241013_201056403.png";
      ...
      <section className="z-10 bg-trasparent">
        <div className="grid max-w-screen-xl gap-50 px-10 md:px-20 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <p className="max-w-2xl text-base font-mono mb-6 text-[#ABB2BF] mt-10 font-light lg:mb-8 md:text-1xl"></p>
            <div className="flex mb-10 sidenav gap-5">
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://github.com/AbdulMoiz-Ali"
                className="iconaocial"
              >
                <svg
